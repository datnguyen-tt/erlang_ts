;;; funcs.el --- Erlang TS Layer functions File for Spacemacs
;;
...
(defun spacemacs//erlang-setup-backend ()
  ...
  (when (eq erlang-backend 'edts) (spacemacs//erlang-setup-edts))
  )

;; (defun spacemacs//erlang-setup-company ()
;;   "Conditionally setup company based on backend."
;;   ;; Activate edts company explicitly to activate
;;   ;; standard backends as well
;;   (when (eq erlang-backend 'edts)
;;     (spacemacs|add-company-backends
;;       :backends company-capf
;;       :modes erlang-mode
;;       :append-hooks t)))

(defun spacemacs//erlang-setup-edts ()
  "Setup edts backend."
  (message "Using `edts' as Erlang backend!")
  )
